...
```sh
npm install --save inferno@beta16
```
...
npm install --save inferno-component@beta16
# server-side rendering
npm install --save inferno-server@beta16
# routing
npm install --save inferno-router@beta16
``` 

Pre-bundled files for browser consumption can be found on [our cdnjs](https://cdnjs.com/libraries/inferno):
 
```
https://cdnjs.cloudflare.com/ajax/libs/inferno/1.0.0-beta16/inferno.min.js
```
...
#### Hyperscript:
```sh
npm install --save inferno-hyperscript@beta16
```

#### createElement:
```sh
npm install --save inferno-create-element@beta16
```

### Compatability with existing React apps
```sh
npm install --save-dev inferno-compat@beta16
```

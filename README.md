...
```sh
npm install --save inferno@beta26
```
...
npm install --save inferno-component@beta26
# server-side rendering
npm install --save inferno-server@beta26
# routing
npm install --save inferno-router@beta26
```

Pre-bundled files for browser consumption can be found on [our cdnjs](https://cdnjs.com/libraries/inferno):

```
https://cdnjs.cloudflare.com/ajax/libs/inferno/1.0.0-beta26/inferno.min.js
```
...
#### Hyperscript:
```sh
npm install --save inferno-hyperscript@beta26
```

#### createElement:
```sh
npm install --save inferno-create-element@beta26
```

### Compatibility with existing React apps
```sh
npm install --save-dev inferno-compat@beta26
```

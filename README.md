...
- [**Online interface to TMDb movie database** (@codesandbox.io)](https://codesandbox.io/s/9zjo5yx8po): Inferno + [Inferno hyperscript](https://github.com/infernojs/inferno)(view) + [Superagent](https://github.com/visionmedia/superagent) (network requests) + Web 
component (custom elements v1) + [state-transducer](https://github.com/brucou/state-transducer) (state machine library) 

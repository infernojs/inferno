...
- [**Online interface to TMDb movie database (@codesandbox.io)**](https://codesandbox.io/s/9zjo5yx8po): Inferno + Inferno hyperscript(view) + Superagent (network requests) + Web component (custom elements v1) + [state-transducer](https://github.com/brucou/state-transducer) (state machine library) 

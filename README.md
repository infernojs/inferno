...
- [dbmonster](http://infernojs.org/benchmarks/dbmonster/) (for comparison: [React](http://mathieuancelin.github.io/js-repaint-perfs/react/), [Angular 2.0](http://mathieuancelin.github.io/js-repaint-perfs/angular2/opt.html), [Riot](http://mathieuancelin.github.io/js-repaint-perfs/riot/), [Vue](http://mathieuancelin.github.io/js-repaint-perfs/vue/opt.html), [Aurelia](http://jdanyow.github.io/aurelia-dbmonster/), [Ember 2.0](https://dbmonster.firebaseapp.com/) and [Mithril](http://tivac.github.io/js-repaint-perfs/mithril/))

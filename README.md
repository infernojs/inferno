...
```sh
npm install --save inferno@beta17
```
...
npm install --save inferno-component@beta17
# server-side rendering
npm install --save inferno-server@beta17
# routing
npm install --save inferno-router@beta17
``` 

Pre-bundled files for browser consumption can be found on [our cdnjs](https://cdnjs.com/libraries/inferno):
 
```
https://cdnjs.cloudflare.com/ajax/libs/inferno/1.0.0-beta17/inferno.min.js
```
...
#### Hyperscript:
```sh
npm install --save inferno-hyperscript@beta17
```

#### createElement:
```sh
npm install --save inferno-create-element@beta17
```

### Compatability with existing React apps
```sh
npm install --save-dev inferno-compat@beta17
```

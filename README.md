...
```sh
npm install --save inferno@beta40
```
...
# routing
npm install --save inferno-router@beta40
```

Pre-bundled files for browser consumption can be found on [our cdnjs](https://cdnjs.com/libraries/inferno):

```
https://cdnjs.cloudflare.com/ajax/libs/inferno/1.0.0-beta40/inferno.min.js
```
...
#### Hyperscript:
```sh
npm install --save inferno-hyperscript@beta40
```

#### createElement:
```sh
npm install --save inferno-create-element@beta40
```

### Compatibility with existing React apps
```sh
npm install --save-dev inferno-compat@beta40
```

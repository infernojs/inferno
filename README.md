...
```sh
npm install --save inferno@beta41
```
...
npm install --save inferno-component@beta41
# server-side rendering
npm install --save inferno-server@beta41
# routing
npm install --save inferno-router@beta41
```
...
#### Hyperscript:
```sh
npm install --save inferno-hyperscript@beta41
```

#### createElement:
```sh
npm install --save inferno-create-element@beta41
```

### Compatibility with existing React apps
```sh
npm install --save-dev inferno-compat@beta41
```

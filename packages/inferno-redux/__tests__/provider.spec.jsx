...
describe("Provider (JSX)", () => {
  ...
  it("should enforce a single child", () => {
    ...
    expect(() => render(<Provider store={store} />, container)).toThrowError(
      Error
    );
  ...
  it("should work with routing", () => {
    ...
    expect(container.innerHTML).toBe(
      innerHTML(
        '<div class="basic"><a id="dispatch"><span>Hello Tom</span></a></div>'
      )
    );
    ...
    expect(container.innerHTML).toBe(
      innerHTML('<div class="basic2">You\'re a mouse!</div>')
    );
  });

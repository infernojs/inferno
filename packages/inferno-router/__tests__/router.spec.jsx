...
describe('Router (jsx)', () => {
	...
	describe('#history', () => {
		...
		it('should fail on empty routes', () => {
			expect(() => render(<Router url={'/foo/bar'} history={browserHistory} />, container)).to.throw(TypeError);
		});
	});
	describe('#RouterContext', () => {
		it('should fail when `location` is not provided', () => {
			expect(() => render(<RouterContext location={null} />, container)).to.throw(TypeError);
		});
		it('should fail when `matched` is not provided', () => {
			expect(() => render(<RouterContext location={'/'} matched={null} />, container)).to.throw(TypeError);
		});

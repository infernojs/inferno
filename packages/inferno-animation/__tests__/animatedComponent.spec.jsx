...
describe('inferno-animation AnimatedComponent', () => {
  ...
  it('should remove class component extending AnimatedComponent from DOM', (done) => {
    ...
    render(<div><My key="#1">1</My><My key="#2">2</My><My key="#3">3</My></div>, container);
    expect(container.textContent).toBe('123');
    
    render(<div><My key="#1">1</My><My key="#3">3</My></div>, container);
    ...
    var checkRenderComplete_ONE = () => {
      ...
      render(<div><My key="#1">1</My><My key="#4">4</My></div>, container);
  ...
  it('should move class component extending AnimatedComponent from DOM', (done) => {
    ...
    render(<div><My key="#1">1</My><My key="#3">3</My><My key="#2">2</My></div>, container);
    ...
    var checkRenderComplete_ONE = () => {
      ...
      render(<div><My key="#4">4</My><My key="#1">1</My></div>, container);

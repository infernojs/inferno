...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('./inferno-component'), require('mobx'), require('./inferno'), require('./inferno-create-class'), require('hoist-non-inferno-statics')) :
	typeof define === 'function' && define.amd ? define(['inferno-component', 'mobx', 'inferno', 'inferno-create-class', 'hoist-non-inferno-statics'], factory) :
	(global.InfernoMobx = factory(global.Component,global.mobx,global.inferno,global.createClass,global.hoistStatics));
}(this, (function (Component,mobx,inferno,createClass,hoistStatics) { 'use strict';
...
function patchVComponent(lastVComponent, nextVComponent, parentDom, lifecycle, context, isSVG, shallowUnmount) {
    ...
    if (lastType !== nextType) {
        if (isStatefulComponent(nextVComponent)) {
            ...
            patch$1(lastInput, nextInput, parentDom, lifecycle, context, isSVG, true);
        ...
        if (isStatefulComponent(nextVComponent)) {
            ...
            if (instance._unmounted) {
                ...
                if (didUpdate) {
                    patch$1(lastInput$1, nextInput$1, parentDom, lifecycle, childContext, isSVG, shallowUnmount);
            ...
            if (shouldUpdate !== false) {
                ...
                patch$1(lastInput$2, nextInput$2, parentDom, lifecycle, context, isSVG, shallowUnmount);

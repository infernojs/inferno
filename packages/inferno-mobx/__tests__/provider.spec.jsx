...
describe("MobX Provider", () => {
  ...
  describe("updating state", () => {
    ...
    it("should update a statefull component", () => {
      render(
        <Provider store1={stores.store1}><Statefull /></Provider>,
        container
      );
    ...
    it("should update a stateless component", () => {
      render(
        <Provider store1={stores.store1}><Stateless /></Provider>,
        container
      );
    ...
    it("should update a stateless component with stores", () => {
      render(
        <Provider store1={stores.store1}><StatelessWithStores /></Provider>,
        container
      );

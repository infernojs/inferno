...
function runBenchmark(container) {
	...
	const FixedDataTableRow206 = function () {
		return (
			<div
				style={{width: 1083, height: 40, zIndex: 1, transform: 'translate3d(0px,0px,0)', backfaceVisibility: 'hidden'}}
				className={'_1gda'}>
	...
	const FixedDataTableRow360 = function () {
		return (
			<div
				style={{width: 1083, height: 25, zIndex: 1, transform: 'translate3d(0px,40px,0)', backfaceVisibility: 'hidden'}}
				className={'_1gda'}>
	...
	const FixedDataTableRow449 = function () {
		return (
			<div
				style={{width: 1083, height: 32, zIndex: 0, transform: 'translate3d(0px,0px,0)', backfaceVisibility: 'hidden'}}
				className={'_1gda'}>

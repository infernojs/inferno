...
describe('Elements (JSX)', () => {
	...
	it('should set values as properties by default', () => {
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<input title="Tip!">'));
	...
	describe('should correctly handle VNodes as quasi-immutable objects, like ReactElement does', () => {
		...
		it('basic nested component example ', () => {
			...
			expect(container.innerHTML).toBe(
                innerHTML('<div><span>This works!</span><div>Hello world</div><span>This works!</span><div>Hello world</div><span>This works!</span><div>Hello world</div></div>')
            );
		});
	});

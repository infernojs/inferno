...
describe('Update (non-jsx)', () => {
	...
	it('should render a node with dynamic values', () => {
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>Hello world - Inferno Owns</div>'));
		render(template('Inferno', 'Owns'), container);
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>Hello world - Inferno Owns</div>'));
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>Hello world - Inferno </div>'));

		render(template(null, 'Owns'), container);
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>Hello world -  Owns</div>'));

		render(template(null), container);
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>Hello world -  </div>'));
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>Hello world - Test Works!</div>'));
	});
	...
	it('should update a wrapped text node', () => {
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div> foo</div>'));

		render(template('Hello', 'Bar'), container);
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>Hello fooBar</div>'));
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>The foo is dead!</div>'));
	});
	...
	it('should update a wrapped text node', () => {
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>Hello foo</div>'));

		render(template(null, 'Bar'), container);
		expect(
			container.innerHTML
		).toBe(innerHTML('<div> fooBar</div>'));
	...
	it('should update a wrapped text node with 4 arguments', () => {
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>Hello world! and Bar</div>'));

		render(template(null, null, null, null), container);
		expect(
			container.innerHTML
		).toBe(innerHTML('<div></div>'));
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>Hello and Zoo</div>'));
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>Hello poz and Zoo</div>'));

		render(template('The ', 'bar', ' is', ' is dead!'), container);
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>The bar is is dead!</div>'));
	...
	it('should update a node with static text', () => {
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div id="Hello">Hello, World</div>'));

		render(template('Bar'), container);
		expect(
			container.innerHTML
		).toBe(innerHTML('<div id="Bar">Hello, World</div>'));
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div id="foo">Hello, World</div>'));
	});
	...
	it('should patch a wrapped text node with its container', () => {
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div><div>Hello</div></div>'));
	});
	...
	it('should patch a tag node into a text node #2', () => {
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div><span>Good bye!</span></div>'));
	...
	it('should inject dynamic text various places', () => {
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>There is no spoon!</div>'));

		render(div('one'), container);
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>There is one spoon!</div>'));

		render(div(), container);
		expect(
			container.innerHTML
		).toBe(innerHTML('<div>There is  spoon!</div>'));
	...
	it('should render a div tag and remove styling', () => {
		...
		expect(
			container.innerHTML
		).toBe(innerHTML('<div style="color: red; padding-left: 10px;"></div>'));

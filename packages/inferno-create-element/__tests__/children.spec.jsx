...
describe('Children - (JSX)', () => {
  ...
  describe('keyed - children', function() {
    it('Should push to correct location when it keyed list has siblings', function() {
      ...
      expect(container.innerHTML).toBe(innerHTML('<div class="tab-group"><div>Item A</div><div>Item B</div><div id="add">Add</div></div>'));
      let addTab = container.querySelector('#add');
      addTab.click();
      expect(container.innerHTML).toBe(innerHTML('<div class="tab-group"><div>Item A</div><div>Item B</div><div>New 2</div><div id="add">Add</div></div>'));
    ...
    it('Should append child node to correct location when its empty at the beginning ', function() {
      ...
      let addTab = container.querySelector('#add');
      addTab.click();
      expect(container.innerHTML).toBe(innerHTML('<div class="tab-group"><div>New 0</div><div id="add">Add</div></div>'));
      addTab = container.querySelector('#add');
      addTab.click();
    ...
    it('Should append child node to correct location when its empty at the beginning ', function() {
      ...
      let addTab = container.querySelector('#add');
      addTab.click();
      expect(container.innerHTML).toBe(innerHTML('<div class="tab-group"><div id="add">Add</div><div>New 0</div></div>'));
      addTab = container.querySelector('#add');
      addTab.click();
    ...
    it('Should append child node to correct location when its empty at the beginning ', function() {
      ...
      let addTab = container.querySelector('#add');
      addTab.click();
      expect(container.innerHTML).toBe(innerHTML('<div class="tab-group"><div>New 0</div><div id="add">Add</div><div>New 0</div></div>'));
      addTab = container.querySelector('#add');
      addTab.click();
      expect(container.innerHTML).toBe(
    ...
    it('Inline text element before array list', function() {
      ...
      function TabGroup({ tabs }) {
        return <div className="tab-group">inlineText{tabs.map((tab, i) => <Tab key={'Item ' + i} title={tab.title} />)}</div>;
      }
    ...
    it('Inline text element after array list', function() {
      ...
      function TabGroup({ tabs }) {
        return <div className="tab-group">{tabs.map((tab, i) => <Tab key={'Item ' + i} title={tab.title} />)}inlineText</div>;
      }
  ...
  describe('nonKeyed - children', function() {
    ...
    it('Inline text element before array list', function() {
      ...
      function TabGroup({ tabs }) {
        return <div className="tab-group">inlineText{tabs.map((tab, i) => <Tab title={tab.title} />)}</div>;
      }
    ...
    it('Inline text element after array list', function() {
      ...
      function TabGroup({ tabs }) {
        return <div className="tab-group">{tabs.map((tab, i) => <Tab title={tab.title} />)}inlineText</div>;
      }
  ...
  describe('mixed children edge cases', function() {
    ...
    it('NONKEYED - should remove children from correct location when there is 2 dynamic static items and 2 lists', function() {
      ...
      activeTwo = items;
      renderIt();
      expect(container.innerHTML).toBe(innerHTML('<div class="c"><p>static</p><p>static</p><p>a</p><p>b</p><p>c</p></div>'));
  ...
  describe('Functions non keyed', () => {
    it('Should render correctly functions and nodes mixed', () => {
      ...
      render(<A />, container);
      expect(container.innerHTML).toBe(innerHTML('<div><p>1</p><span>abc</span><p>2</p><span>def</span><p>3</p></div>'));
      updaterFirst();
  ...
  describe('VFragment within other nodes', () => {
    it('Should not clear nodes when non keyed', () => {
      ...
      expect(container.innerHTML).toBe(innerHTML('<div><div>test</div><span>1</span><span>2</span><span>3</span><div>end</div></div>'));

      render(<Nodes items={[3, 2, 1]} />, container);
      expect(container.innerHTML).toBe(innerHTML('<div><div>test</div><span>3</span><span>2</span><span>1</span><div>end</div></div>'));

      render(<Nodes items={[9, 8, 7]} />, container);
      expect(container.innerHTML).toBe(innerHTML('<div><div>test</div><span>9</span><span>8</span><span>7</span><div>end</div></div>'));

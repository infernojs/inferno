...
describe('ReactDOMComponent', function () {
  ...
  //     expect(console.error.calls[5].calls.argsFor(0)[0]).toContain(
  //       'See Link > a > ... > Link > a.'
  //     );
  //   });
  // });

	...
	describe('Order of Es6 Lifecycle with string refs and refs', () => {
		it('Should go as per React (minus doubles)', () => {
			...
			class Hello2 extends Component {
				...
				render() {
					return (
						createElement('div', { ref: () =>{console.log('S1', this.refs['S2a'] ? 'stringRef' : null);} }, [
							createElement('div', { ref: 'S2a' }),
							createElement('div', { ref: () =>{console.log('S2b', this.refs['S2a'] ? 'stringRef' : null);} })
						])
					);
				}
			}
			...
			class Hello extends Component {
				...
				render() {
					return (
						createElement('div', { ref: () =>{console.log('1', this.refs['3a'] ? 'stringRef' : null);} }, [
							createElement('div', { ref: () =>{console.log('2a', this.refs['3a'] ? 'stringRef' : null);} }, [
								createElement(Hello2, {}, null),
								createElement('div', { ref: '3a' }, [
									createElement('div', { ref: () =>{console.log('4a', this.refs['3a'] ? 'stringRef' : null);} }),
									createElement('div', { ref: () =>{console.log('4b', this.refs['3a'] ? 'stringRef' : null);} })
								]),
								createElement('div', { ref: () =>{console.log('3b', this.refs['3a'] ? 'stringRef' : null);} })
							]),
							createElement('div', { ref: () =>{console.log('2b', this.refs['3a'] ? 'stringRef' : null);} }, null)
						])
					);
				}
			}

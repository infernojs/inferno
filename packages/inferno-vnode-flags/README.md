...
- `ChildFlags.HasVNodeChildren` is single vNode (Element/Component)
- `ChildFlags.HasNonKeyedChildren` is Array of vNodes non keyed (no nesting, no holes)
- `ChildFlags.HasKeyedChildren` is Array of vNodes keyed (no nesting, no holes)

      ...
      if (matches === null) {
        ...
        if (!propRefs) {
            switch (name) {
              case "class":
              case "className":
                templateParams.push("fragment.templateTypes[" + valueCounter.index + "] = Inferno.FragmentValueTypes.ATTR_CLASS;");
                break;
              case "id":
              ...
              case "scoped":
                ...
                break;
              case "noResize":
                templateParams.push("fragment.templateTypes[" + valueCounter.index + "] = Inferno.FragmentValueTypes.ATTR_NO_RESIZE;");
                break;
              default:

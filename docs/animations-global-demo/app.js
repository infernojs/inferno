(function() {
  ...
  function Logo () {
    return (
      createElement('div', { className: "logo" },
        createElement('img', { width: "120px", height: "120px", src: "inferno-logo.svg" })
      )
    );
  }
  ...
  function Payoff () {
    return (
      createElement('h2', { className: "payoff" }, "Inferno is a blazingly fast framework.")
    );
  }
  ...
  function PageOne({ onClick }) {
    return (
      createElement('div', { className: "Page" }, [
        createElement('div', { className: "Menu"}, createElement('div', { className: "body"}, [
          createElement('h3', null, "Page 1"),
        ])),
  ...
  function PageTwo({ onClick }) {
    ...
    didClick(e) {
      ...
      this.setState({
        ...
        null,
        this.state.page === 0
          ? createElement(PageOne, { onClick: this.didClick })
          : createElement(PageTwo, { onClick: this.didClick })
        );
		}
	}
    ...
    Inferno.render(createElement(App, {

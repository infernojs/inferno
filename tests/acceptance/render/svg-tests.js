    ...
    describe('SVG tests', () => {
       ...
       describe('should respect SVG namespace', () => {
           ...
           it('Initial render (creation)', () => {
               ...
               template = Inferno.createTemplate((createElement, val1) =>
       ...
       describe('should respect SVG namespace and render SVG attributes', () => {
		   ...
		   it('Initial render (creation)', () => {
              template = Inferno.createTemplate((createElement, val1) =>
					  createElement('svg', {xmlns: 'http://www.w3.org/2000/svg', version: '1.1', baseProfile: 'full', width: '200', height: '200'}, null)
              );
              Inferno.render(Inferno.createFragment(false, template), container);

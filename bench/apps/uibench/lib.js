// uibench state model and test cases by Boris Kaul (localvoid/uibench-base, MIT),
// ported to ESM in scripts/fakedom/libs/uibench.js. Only the export list differs.
// State generators and test cases are deterministic (Math.random only appears in the unused preserveStateTest).
  ...
  export { config, init, initTests, specTest, AppState, HomeState, TableState, AnimState, TreeState, TestCase };

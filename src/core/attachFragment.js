    ...
    if (fragment.templateValue) {
        switch (fragment.templateType) {
            ...
            case fragmentValueTypes.COMPONENT_REPLACE:
                ...
                const {
                    newElement, component, mountCallback
                } = attachComponent(fragment.templateElement, fragment.templateValue, fragment.templateComponent, fragment.dom, replace);
        ...
        for (let i = 0, length = fragment.templateValues.length; i < length; i++) {
            ...
            switch (fragment.templateTypes[i]) {
                ...
                case fragmentValueTypes.COMPONENT_REPLACE:
                    const {
                        newElement, component, mountCallback
                    } = attachComponent(element, value, fragment.templateComponents[i], fragment.dom);

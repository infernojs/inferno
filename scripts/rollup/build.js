...
(async () => {
  ...
  // The import stream is NodeJS specific and should always be marked as external
  ...
  const targets = [
    ...
    Object.assign({}, defaultOptions, { env: 'development', format: 'es', esnext: false, minify: false, ext: '.dev.esm.js' }),
    //esmProd --name=index --ext=.esm.js --env=production --format=es --minify=false
    Object.assign({}, defaultOptions, { env: 'production', format: 'es', esnext: false, minify: false, ext: '.esm.js' }),
